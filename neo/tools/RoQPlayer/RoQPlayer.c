/*
#
# RoQPlayer - a simple RoQ format VideoPlayer program
#
# Copyright (C) 2014 Daniel Mehrwald
#
...
int main(int argc, char *argv[])
{
    ...
    avpicture_fill( ( AVPicture* )frame2, image, AV_PIX_FMT_BGR32, img_width, img_height );
